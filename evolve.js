...
const perks = [
	...
	[ 'wheelbarrow', 'achievements' ],
	[ 'extinct_sludge', 'achievements' ],
...
const upgradeList = [];
let i;
let blackholeDesc = tradeDesc1 = tradeDesc2 = mass_extinctionDesc = creatorDesc = '';
let minersDesc = explorerDesc = joylessDesc = steelenDesc = extinct_sludgeDesc = '';
let wheelbarrowDesc = whitehole2Desc = whitehole3Desc = heavyweightDesc = anarchistDesc = '';
let technoDesc5 = gladiatorDesc = novice1Desc = novice2Desc = journeyman1Desc = '';
let journeyman2Desc = adept1Desc = adept2Desc = '';
for (i = 1; i <= 5; i++) {
	blackholeDesc += i * 5;
	...
	steelenDesc += i * 2;
	if (i < 5) steelenDesc += '% / ';
    extinct_sludgeDesc += i * 3;
    if (i < 5) extinct_sludgeDesc += '% / ';
	wheelbarrowDesc += i * 2;
	if (i < 5) wheelbarrowDesc += '% / ';
	whitehole2Desc += (i * 5);
	if (i < 5) whitehole2Desc += '% / ';
	whitehole3Desc += i;
	if (i < 5) whitehole3Desc += ' / ';
	heavyweightDesc += (i * 4);
...
const perksDesc = {
	...
	wheelbarrow: loc("achieve_perks_wheelbarrow",[wheelbarrowDesc]),
	extinct_sludge: loc("achieve_perks_extinct_sludge",[extinct_sludgeDesc]),
	whitehole: [
		loc("achieve_perks_whitehole"),
		loc("achieve_perks_whitehole2",[whitehole2Desc]),
		loc("achieve_perks_whitehole3",[whitehole3Desc])
	],
	heavyweight: loc("achieve_perks_heavyweight",[heavyweightDesc]),
	banana: [
		loc("achieve_perks_banana1",[50]),
		loc("achieve_perks_banana2",[1]),
		loc("achieve_perks_banana3",[10]),
		loc("achieve_perks_banana4",[3]),
        loc("achieve_perks_banana5",[0.01])
	],
    dissipated: [
	...
	pathfinder: [
		'0 Star: '+loc("achieve_perks_pathfinder1",[10]),
        '1 Star: '+loc("achieve_perks_pathfinder2",[10]),
        '2 Star: '+loc("achieve_perks_pathfinder3"),
        '3 Star: '+loc("unavailable_content"),
        '4 Star: '+loc("unavailable_content"),
    ],
	novice: [
        loc("achieve_perks_novice",[novice1Desc, novice2Desc]),
	...
	adept: loc("achieve_perks_adept",[adept1Desc,adept2Desc])
}
